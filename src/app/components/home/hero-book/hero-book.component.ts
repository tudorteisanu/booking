...
import { FormSelectComponent } from '@/components/base/form-select/form-select.component';
import { SearchComponent } from '@/components/base/search/search.component';

@Component({
  selector: 'app-hero-book',
  standalone: true,
  imports: [TextFieldComponent, FormSelectComponent, SearchComponent],
